 ...
 *  Realiza el juego de los barquitos pero con un vector. Sólo se pondrán submarinos
 ...
 * - El juego termina cuando uno de los dos acaba con la flota del otro. Lógicamente se llevarán dos paneles para cada jugador: uno para su flota y otro para sus
 * tiradas. Se irá mostrando el de sus tiradas. Al final del juego se muestran todos los
 * paneles.
 *
 */
